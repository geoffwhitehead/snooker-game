...
void main(void) {
	...
	table->getRenderObject()->SetModelMatrix(table->getRenderObject()->GetModelMatrix() * Matrix4::Scale(Vector3(SNOOKER_WIDTH, SNOOKER_HEIGHT, 1)));
	tbl_left->getRenderObject()->SetModelMatrix(tbl_left->getRenderObject()->GetModelMatrix() * Matrix4::Scale(Vector3(3, SNOOKER_HEIGHT - POCKET_WIDTH, 1)));
	tbl_right->getRenderObject()->SetModelMatrix(tbl_right->getRenderObject()->GetModelMatrix() * Matrix4::Scale(Vector3(3, SNOOKER_HEIGHT - POCKET_WIDTH, 1)));
	tbl_bottom->getRenderObject()->SetModelMatrix(tbl_bottom->getRenderObject()->GetModelMatrix() * Matrix4::Scale(Vector3(SNOOKER_WIDTH - POCKET_WIDTH, 3, 1)));
	tbl_left->getRenderObject()->SetModelMatrix(tbl_left->getRenderObject()->GetModelMatrix() * Matrix4::Scale(Vector3(SNOOKER_WIDTH - POCKET_WIDTH, 3, 1)));
	...
	AddEntityObject(new Entity("red9", Vector3(350.0f, 1.0f, 1.0f), Vector3(1.0f, 1.0f, 1.0f), Vector3(1.0f, 1.0f, 1.0f), mesh_circle, shader_basic));
	...
	AddEntityObject(new Entity("green", Vector3(39.0f, 1.0f, 1.0f), Vector3(1.0f, 1.0f, 1.0f), Vector3(1.0f, 1.0f, 1.0f), mesh_circle, shader_basic));
	...
	AddEntityObject(new Entity("brown", Vector3(39.0f, 1.0f, 1.0f), Vector3(1.0f, 1.0f, 1.0f), Vector3(1.0f, 1.0f, 1.0f), mesh_circle, shader_basic));
	AddEntityObject(new Entity("white", Vector3(39.0f, 1.0f, 1.0f), Vector3(1.0f, 1.0f, 1.0f), Vector3(1.0f, 1.0f, 1.0f), mesh_circle, shader_basic));
	...
	// add render objects
	r.AddRenderObject(*table->getRenderObject());
	for (int i = 0; i < 26; i++)
	{
