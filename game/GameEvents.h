...
public:
	...
	enum eLogicEvents { LE_PLACED_WHITE, LE_POT_RED, LE_POT_WHITE, LE_POT_BLUE, LE_POT_PINK, LE_POT_GREEN, LE_POT_BLACK };
	enum eInputEvents { IE_POT_WHITE, IE_STRIKE_CUE, IE_WHITE_PLACED };
	enum eSoundEvents { SE_POT, SE_STRIKE_BALL, SE_STRIKE_CUSHION, SE_POT_WHITE, SE_STRIKE_CUE };
	...
	eGameState game_state = GS_PLACE_WHITE;
	eBallOn ball_on = BO_RED;
